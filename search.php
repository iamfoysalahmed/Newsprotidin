        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $offset = ($page - 1) * $limit;
                    $sql = "SELECT post.post_id, post.title, post.description, post.post_date, post.category, category.category_name, user.username, user.role, post.author, post.post_img from post 
